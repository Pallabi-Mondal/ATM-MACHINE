...
def Create_account():
    ...
    root1.wm_iconbitmap(r"C:\Users\HP\Documents\GUI PYTHON\atmicon.ico")
            ...
            with open("ATM.txt","r") as file:
                ...
                for i in data:
                    if i.startswith("Account Number: "+Accn):
                        ...
                        root2.wm_iconbitmap(r"C:\Users\HP\Documents\GUI PYTHON\atmicon.ico")
...
def get_account():
    ...
    new_root.wm_iconbitmap(r"C:\Users\HP\Documents\GUI PYTHON\atmicon.ico")
    new_root.title("ATM MACHINE")

    image=Image.open(r"C:\Users\HP\Documents\GUI PYTHON\a.jpg")
                        ...
                        if len(data)==0 and Accn!="00000000000":
                            ...
                            with open("ATM.txt","r") as file:
                                ...
                                #The or operator is used to combine these two conditions. If either of them is True, the entire expression evaluates to True. Otherwise, if both are False, the entire expression evaluates to False.    
                                        ...
                                        new_root2.wm_iconbitmap(r"C:\Users\HP\Documents\GUI PYTHON\atmicon.ico")
                                        ...
                                        def deposit():
                                            ...
                                            root3.wm_iconbitmap(r"C:\Users\HP\Documents\GUI PYTHON\atmicon.ico")
                                            root3.title("ATM DEPOSIT")
                                            # root3.configure(bg="black")

                                            image=Image.open(r"C:\Users\HP\Documents\GUI PYTHON\d.jpg")
                                            photo=ImageTk.PhotoImage(image)
                                                                ...
                                                                if Ac==get_binary(acn.get()):
                                                                    with open("ATM.txt","r+") as f:
                                                                        ...
                                                                        if val==True:
                                                                            ...
                                                                            root4.wm_iconbitmap(r"C:\Users\HP\Documents\GUI PYTHON\atmicon.ico")
                                                                            ...
                                                                            def sub1():
                                                                                ...
                                                                                if Ac1:
                                                                                    if Ac1.isdigit() and int(Ac1)>0:
                                                                                        pygame.init()
                                                                                        audio_path = r"C:\Users\HP\Documents\GUI PYTHON\machine sound.mp3"
                                                                                        ...
                                                                                        if int(Ac1)<=50000:
                                                                                            ...
                                                                                            root5.wm_iconbitmap(r"C:\Users\HP\Documents\GUI PYTHON\atmicon.ico")
                                                                                            root5.title("ATM DEPOSIT")
                                                                                            # root5.configure(bg="black")
                                                                                            image=Image.open(r"C:\Users\HP\Documents\GUI PYTHON\b.jpg")
                                                                                            photo=ImageTk.PhotoImage(image)
                                        ...
                                        def forget_pin():
                                            ...
                                            image=Image.open(r"C:\Users\HP\Documents\GUI PYTHON\refresh.png")
                                                                    ...
                                                                    def sub1():
                                                                        if ak.get():
                                                                            if ak.get()==cap["text"] and len(ak.get())==20:
                                                                                ...
                                                                                new_root3.wm_iconbitmap(r"C:\Users\HP\Documents\GUI PYTHON\atmicon.ico")
                                                                                        ...
                                                                                        if acn_k.get():
                                                                                            if len(acn_k.get())==20:
                                                                                                if acn_k.get()==ak.get():
                                                                                                    ...
                                                                                                    root6.wm_iconbitmap(r"C:\Users\HP\Documents\GUI PYTHON\atmicon.ico")
                                                                                                        ...
                                                                                                        if acn.get():
                                                                                                            if acn.get().isdigit() and len(acn.get())==11:
                                                                                                                if acn.get()==a_num.get():
                                                                                                                    ...
                                                                                                                    root7.wm_iconbitmap(r"C:\Users\HP\Documents\GUI PYTHON\atmicon.ico")
                                                                                                                    root7.title("ATM MACHINE CSAH DEPOSIT")               

                                                                                                                    image=Image.open(r"C:\Users\HP\Documents\GUI PYTHON\c.jpg")
                                                                                                                    photo=ImageTk.PhotoImage(image)
...
if __name__=="__main__":
    ...
    root.wm_iconbitmap(r"C:\Users\HP\Documents\GUI PYTHON\atmicon.ico")
